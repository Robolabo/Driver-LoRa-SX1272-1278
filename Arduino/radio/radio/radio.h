...
#include "../radio/halLora.h"										//LLAMADO A LIBRERIA HAL.CPP
...
//UTILICE LOS PARAMETROS para RADIO.sf   RADIO.bw    RADIO.cr
...
struct radio_t {
    ...
    u1_t 		version;						//se incorpora para seguimiento de comunicacion
};
//struct radio_t RADIO

DECLARE_RADIO; //!< \internal
